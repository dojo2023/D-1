...
<body>
    ...
    <div class = "register-html">
		...
		<div class = "big-group">
		     ...
		     <br><input type="text" name="USER_ADDR" class = "input" placeholder= "メールアドレス">
			 <br><input type="text" name="USER_PW" class="input" placeholder="パスワード">
			 <br><input type="text"  class="input" placeholder="パスワードをもう一度入力してください"><br>
		 </div>
		 ...
		 <input type="text" name="USER_ANSWER" class="input" placeholder="秘密の質問の答え"><br>
     </div>
