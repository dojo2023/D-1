		...
		<div class="profile">
			...
			<form method="POST" action="/mippy/ProfileServlet">
				<c:forEach var="e" items="${cardList }">
					...
					<input type="text" name="USER_NICKNAME" class="input"
						value="${e.user_nickname}" required>
					<br>

					<div class="te">身長</div>
					<div class="same">
						<input type="text" name="USER_HEIGHT" class="input"
							value="${e.user_height}" pattern="[0-9]+(\.[0-9]+)?" required>cm<br>

					</div>
					<div class="te">体重</div>
					<div class="same">
						<input type="text" name="USER_WEIGHT" class="input"
							value="${e.user_weight}" pattern="[0-9]+(\.[0-9]+)?" required>kg<br>
					</div>
					<div class="te">性別</div>
					<div class="sei">
						<div class="same">
					...
					<div class="same">
						<input type="date" name="USER_BIRTH" class="input"
							value="${e.user_birth}"> <br>
					</div>
					<div class="te">目標体重</div>
					<div class="same">
						<input type="text" name="USER_GOALW" class="input"
							value="${e.user_goalw}" pattern="[0-9]+(\.[0-9]+)?" required>kg<br>
					</div>
					<div class="te">期限</div>
					<div class="same">
						<input type="date" name="USER_LIMIT" class="input"
							value="${e.user_limit}">まで！<br>
					</div>
					<div class="te">アバター</div>
					<div class="sei">
						<div class="same">
							<select id="avatar-select" name="USER_AVATAR" class="input"
								onchange="showAvatarImage()">
					...
					<div class="avatar-container">
						<img id="avatar-image-1" class="avatar-image"
							src="img/mippy_1.gif"> <img id="avatar-image-2"
							class="avatar-image" src="img/mippy_2.gif"> <img
							id="avatar-image-3" class="avatar-image" src="img/mippy_3.gif">
						<img id="avatar-image-4" class="avatar-image"
							src="img/mippy_4.gif"> <img id="avatar-image-5"
							class="avatar-image" src="img/mippy_5.gif"> <img
							id="avatar-image-6" class="avatar-image" src="img/mippy_6.gif">
						<img id="avatar-image-7" class="avatar-image"
							src="img/mippy_7.gif"> <img id="avatar-image-8"
							class="avatar-image" src="img/mippy_8.gif"> <img
							id="avatar-image-9" class="avatar-image" src="img/mippy_9.gif">
						<img id="avatar-image-10" class="avatar-image"
							src="img/mippy_10.gif">
					</div>
				</c:forEach>
				...
				<!-- 背景色 -->
				<br> <select id="color-select" name="USER_COLOR"
					onchange="changeBackgroundColor()" hidden>
